<script>
    ...
    async function updateTask() {
        ...
        tasks[indexTask].date = resultDate.startDate;
            ...
            <form on:submit|preventDefault={updateTask}>
                <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                    ...
                    <div class="w-full">
                        ...
                        >Date*</label
                        >
                        <Datepicker startDate="{date}" endDate="{startDateRoadmap}" minDate="{startDateRoadmap}" maxDate="{endDateRoadmap}"   bind:result="{resultDate}"   />
