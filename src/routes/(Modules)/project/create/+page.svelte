<script>
    ...
    let image, desc, visibility, startDate, endDate, title, dateResult, type, ongoing;
        ...
        <form on:submit|preventDefault={addProject}>
            <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                ...
                <div class="w-full">
                    ...
                    >Start Date*</label
                    >
                    <Datepicker {startDate} {endDate} bind:result={dateResult} range="{!ongoing}"/>
                </div>
                <!--{#if !ongoing}-->
                <!--  <div class="w-full">-->
                <!--    <label-->
                ...
                <!--    <DatePicker range bind:value={startDate}/>-->
